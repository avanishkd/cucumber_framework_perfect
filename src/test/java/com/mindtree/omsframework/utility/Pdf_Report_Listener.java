...
public class Pdf_Report_Listener implements ITestListener  {
	/**
	 * Document
	 */
	 ...
	 * JyperionListener
	 */
	public Pdf_Report_Listener() {
		log("Pdf_Report_Listener()");
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			TestBase_OpenBrowser_TakeData_config.takeSnapShot(TestBase_OpenBrowser_TakeData_config.getDriver(), file);
		} catch (Exception e) {
